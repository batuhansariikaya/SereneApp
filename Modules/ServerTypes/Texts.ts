...
namespace ExamAppSerene.Texts {
    ...
    export declare namespace Db {
        ...
        namespace School {
            ...
            namespace Question {
                export const AnswerKey: string;
                export const CreatedDate: string;
                export const ExamId: string;
                export const ExamName: string;
                export const OptionA: string;
                export const OptionB: string;
                export const OptionC: string;
                export const OptionD: string;
