...
using System.Data;
using System.Linq;
using MyRepository = ExamAppSerene.Administration.Repositories.UserPermissionRepository;
using MyRow = ExamAppSerene.Administration.UserPermissionRow;

namespace ExamAppSerene.Administration.Endpoints
{
