import{b as i}from"../../../../_chunks/chunk-LJ7TVK7G.js";import{a as e}from"../../../../_chunks/chunk-LYMRDNRA.js";import{a as o,b as s,e as d,f as u}from"../../../../_chunks/chunk-K3EI6ARL.js";var n=s(u(),1),r=s(d(),1);$(function(){new t($("#ForgotPasswordPanel"))});var t=class extends n.PropertyPanel{getFormKey(){return i.formKey}constructor(m){super(m),this.byId("SubmitButton").click(a=>{if(a.preventDefault(),!!this.validateForm()){var c=this.getSaveEntity();(0,r.serviceCall)({url:(0,r.resolveUrl)("~/Account/ForgotPassword"),request:c,onSuccess:l=>{(0,r.information)(e.Forms.Membership.ForgotPassword.SuccessMessage,()=>{window.location.href=(0,r.resolveUrl)("~/")})}})}})}getTemplate(){return`<h2 class="text-center p-4">
    <img src="${(0,r.resolveUrl)("~/Content/site/images/serenity-logo-w-128.png")}"
        class="rounded-circle p-1" style="background-color: var(--s-sidebar-band-bg)"
        width="50" height="50" /> ExamAppSerene
</h2>
